 ...
 */
final class Version20230510115028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id UUID NOT NULL, fight_category_id UUID DEFAULT NULL, name VARCHAR(255) NOT NULL, location TEXT NOT NULL, location_link TEXT DEFAULT NULL, time_start TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL, time_end TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL, description TEXT DEFAULT NULL, capacity INT DEFAULT NULL, vip BOOLEAN NOT NULL, image_name VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, created_at TIMESTAMP(6) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at TIMESTAMP(6) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id))');
