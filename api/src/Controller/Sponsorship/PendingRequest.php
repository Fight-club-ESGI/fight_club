...
class PendingRequest extends AbstractController
{
    ...
    public function __invoke()
    {
        ...
        return $this->sponsorshipRepository->findBy(['sponsor' => $sponsor->getId(), 'emailValidation' => true, 'sponsorValidation' => false]);
    }
}
