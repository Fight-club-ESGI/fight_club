<template>
  <div class="flex flex-column gap-4">
    <div v-for="event of events" :key="event.id"
      @click="router.push({ name: 'event-details', params: { id: event.id } })" class="cursor-pointer">
      <v-card class="grid grid-cols-5">
        ...
        <div class="col-span-1">
          <v-img :src="event.locationLink ? event.locationLink : 'https://placeholder.com/150?text=UpdateImageLink'"
            height="150" />
        </div>
